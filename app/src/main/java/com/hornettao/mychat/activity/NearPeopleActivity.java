...
import com.hornettao.mychat.adapter.NearPeopleAdapter;
 ...
 * 附近的人列表
 */
public class NearPeopleActivity extends Base2Activity implements XListView.IXListViewListener, OnItemClickListener {
...
//		userManager.queryNearTotalCount(User.class, "location", longtitude, latitude, true,"sex",false,new CountListener() {
			...
			public void onSuccess(int arg0) {
				...
				if(arg0 >nears.size()){
					...
					T.showShort(NearPeopleActivity.this, "数据加载完成");
					mListView.setPullLoadEnable(false);
					refreshLoad();
				}
			}
