...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private BadgeView contactsBadgeView;

	public int getChatBadgeViewCount() {
		return chatBadgeView.getBadgeCount();
	}

	public void setChatBadgeViewCount(int chatBadgeViewCount) {
		chatBadgeView.setBadgeCount(chatBadgeViewCount);
	}

	public int getContactsBadgeViewCount() {
		return contactsBadgeView.getBadgeCount();
	}

	public void setContactsBadgeViewCount(int contactsBadgeViewCount) {
		contactsBadgeView.setBadgeCount(contactsBadgeViewCount);
	}
...
//				if (chatBadgeView.isShown() && position != 0) {
//					chatBadgeView.setBadgeCount(0);
//				}
//				if (contactsBadgeView.isShown() && position != 1) {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (i == 1) {
					...
					contactsBadgeView.setBadgeCount(0);
					contactsBadgeView.setBadgeMargin(0, DensityUtils.getPX(getContext(), 5), 0, 0);
				}
