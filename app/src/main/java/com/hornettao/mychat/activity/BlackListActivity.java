...
import com.hornettao.mychat.adapter.BlackListAdapter;
			...
			public void onClick(DialogInterface dialogInterface, int userId) {
				...
				userManager.removeBlack(user.getUsername(),new UpdateListener() {
					...
					public void onSuccess() {
						// TODO Auto-generated method stub
						T.showShort(BlackListActivity.this, "移出黑名单成功");
						//重新设置下内存中保存的好友列表
						MyChatApplication.getInstance().setContactList(CollectionUtils.list2map(BmobDB.create(getApplicationContext()).getContactList()));
					}
					
					@Override
					public void onFailure(int arg0, String arg1) {
						// TODO Auto-generated method stub
						T.showShort(BlackListActivity.this, "移出黑名单失败:" + arg1);
					}
				});
			}
		});
